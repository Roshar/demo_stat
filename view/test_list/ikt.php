<style>
    ...
    *{
    ...
    .pre-wrapper__form{
        ...
        background-image: url('/img/teacher-test.png');
    }
    ...
    <div class="content-pre-form">
        <div class="pre-wrapper__form">
            <div class="first-element">
                <h1>Тест «Цифровая грамотность»</h1>
            </div>
            <div class="second-element">
                <h2>Дорогой учитель,
                    перед вами — необычный тест.</h2>
                <p>
                    Это 24 ситуации, которые могут произойти с каждым педагогом. Ваша задача — выбрать, как бы вы поступили в каждой из них. При выборе учитывайте гибкие навыки учителя, а не специфику учебного предмета.</p>

                <p>Мы уверены, что вы хорошо знаете, как «надо». Но просим: отвечая, выбирайте тот вариант, который действительно совпадает с вашими поступками в реальной жизни. Ваши ответы не увидит никто кроме вас. И никто не оценит вас лучше, чем вы сам.
                </p>
                <ul>
...
<div class="wrapper-clear">
    <div class="content-form">
        <div class="content__text-second-block">
            ...
            <div class="notice"><?php if(!empty($er)){
                    echo "<div class='flash'>
                            <div class='flash-content'>
                                <h2>Заполните все поля!</h2>
                            </div>
                            ...
                            <div class="teacher_fields__block">
                                ...
                                <div class="half">
                                    <input type="text" id="email" name="email"
                                        <?php if(isset($er['email'])){echo "class='invalid'";}?>
                                           value="<?php if(isset($_POST['email'])){echo $_POST['email'];}?>"
                                           placeholder="Электронный почтовый адрес">
                                    <input type="text" id="phone" name="phone"
                                        <?php if(isset($er['phone'])){echo "class='invalid'";}?>
                            ...
                            <div class="teacher_fields__block">
                                ...
                                <div class="half">
                                    <input type="text" id="firstname" name="firstname"
                                        <?php if(isset($er['firstname'])){echo "class='invalid'";}?>
                                           value="<?php if(isset($_POST['firstname'])){echo $_POST['firstname'];}?>"
                                           placeholder="Имя">
                                    <input type="text" id="secondname" name="lastname"
                                        <?php if(isset($er['lastname'])){echo "class='invalid'";}?>
